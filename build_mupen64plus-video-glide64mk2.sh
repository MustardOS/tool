...
REPO_URL="https://github.com/mupen64plus/mupen64plus-video-glide64mk2.git"
REPO_DIR="$SCRIPT_DIR/mupen64plus-video-glide64mk2"
PATCH_DIR="$SCRIPT_DIR/mp64-patches"
REPO_NAME="$(basename "$REPO_DIR")"

echo "[1/8] Cloning mupen64plus-video-glide64mk2..."
rm -rf "$REPO_DIR"
...
echo "[4/8] Configuring Building mupen64plus-video-glide64mk2"
...
# Force triplet pkg-config to avoid host detection
export PKG_CONFIG="${XHOSTP}-pkg-config"
...
VULKAN=0 USE_GLES=1 NEW_DYNAREC=1 OPTFLAGS="-O3" V=1 PIE=1 ACCURATE_FPU=1 HOST_CPU=aarch64 GL_CFLAGS="" GL_LDLIBS="-lEGL -lGLESv2" PKG_CONFIG="aarch64-buildroot-linux-gnu-pkg-config" SDL_CONFIG="aarch64-buildroot-linux-gnu-sdl2-config" \
make -C "mupen64plus-video-glide64mk2/projects/unix" -j"$(nproc)" all

echo "[6/8] Stripping mupen64plus-video-glide64mk2 binary..."
$STRIP "mupen64plus-video-glide64mk2/projects/unix/mupen64plus-video-glide64mk2.so" || true
